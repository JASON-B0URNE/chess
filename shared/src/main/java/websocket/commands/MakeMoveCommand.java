...
public class MakeMoveCommand {
    private final UserGameCommand.CommandType commandType = UserGameCommand.CommandType.MAKE_MOVE;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getCommandType(), getAuthToken(), getGameID(), move);
    }
}
